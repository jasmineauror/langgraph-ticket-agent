...
**Inviting.** Enter an email address and choose a role. Invitations expire after
14 days and can be resent or revoked from the same page. If your plan has a fixed
seat count, an invitation reserves a seat as soon as it is sent, not when accepted.

**Roles.** Owner has full control including billing and workspace deletion. Admin
